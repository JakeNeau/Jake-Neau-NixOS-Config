...
**Full documentation lives in [`docs/`](docs/README.md)** — tutorials, how-to guides, reference, and explanation. `.agents/skills/nix-config/` is the agent-facing guide.
...
- [x] Document the SOPS workflow (done — see [docs/how-to/add-a-secret.md](docs/how-to/add-a-secret.md))
