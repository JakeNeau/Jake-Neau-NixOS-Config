...
let
  ...
  codeLldbPath =
    ...
    in
    "${extension}/share/vscode/extensions/vadimcn.vscode-lldb/adapter/codelldb";
  mkPiSettingsUpdater =
    pkgs:
  ...
  flake.programs.pi = {
    ...
    config =
      ...
      let
        ...
        promptFiles = lib.filterAttrs (name: type: type == "regular" && lib.hasSuffix ".md" name) (
