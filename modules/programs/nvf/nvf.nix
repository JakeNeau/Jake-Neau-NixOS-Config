    ...
    in
    {
      ...
      programs.nvf = {
        ...
        settings.vim = {
          ...
          # upstream.
          pluginRC.flutter-tools = lib.mkForce (
          ...
          autocomplete.nvim-cmp = {
            ...
            setupOpts = {
              ...
              mapping."<CR>" = lib.mkForce (lib.generators.mkLuaInline "cmp.mapping.confirm({ select = false })");
              # Explicit accept: <C-y> confirms the highlighted (or first) item,
              # for when you want to commit without reaching for Tab.
              mapping."<C-y>" = lib.generators.mkLuaInline "cmp.mapping.confirm({ select = true })";
            };
          };
          ...
          utility.snacks-nvim = {
            ...
            setupOpts.picker =
              let
                feed =
                  k:
                  lib.generators.mkLuaInline "function() vim.api.nvim_feedkeys(vim.api.nvim_replace_termcodes('${k}', true, false, true), 'n', false) end";
