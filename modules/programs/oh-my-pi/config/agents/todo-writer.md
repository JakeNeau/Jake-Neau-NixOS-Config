...
You see only the task handed to you and this machine's global context (AGENTS.md), not the
...
tracks TODOs — check the project's skill directories (`.agents/skills/`, or a
vendor path like `.claude/skills/`) for a skill about TODOs or task tracking and
read its `SKILL.md`. It tells you where TODOs live, what
